#!/usr/bin/python
version="1.0"#Sacare unas versiones nuevas dentro de un tiempo para que se eficaz
made="† Eternal Demon †"
title = '''
…………………▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄
……………▄▄█▓▓▓▒▒▒▒▒▒▒▒▒▒▓▓▓▓█▄▄
	...
	def doconnection(self):
		...
		while socks < int(self.threads):
			try:
				...
				break
				sys.exit(cprint('[+] Attack canceled by user','red'))
		print ('We\'ve sent ')(str(self.pkt_count)(' packets successfully. We\'re sleeping for ')(self.sleep)(' seconds')
